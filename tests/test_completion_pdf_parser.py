...
class CompletionPdfParserTest(unittest.TestCase):
    ...
    def test_parse_lobc_completion_sample(self) -> None:
        ...
        self.assertEqual(fields["completionNo"], "COM")
        self.assertEqual(fields["wellboreNo"], "00")
        self.assertEqual(fields["groundElev"], "963.43")
        self.assertEqual(fields["dol"], "125.00")
        self.assertEqual(fields["dfs"], "7.50")
        self.assertEqual(fields["dailyCost"], "$0")
        self.assertEqual(fields["cumulativeCost"], "$0")
        self.assertEqual(fields["afeCost"], "$1,093,800")
